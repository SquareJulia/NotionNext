...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'xiaosiyier', // 主题， 支持 ['next','hexo',"fukasawa','medium','example'] @see https://preview.tangly1024.com
  ...
  CONTACT_GITHUB: 'https://github.com/SquareJulia', // 你的github个人主页
